...
exports.saveNewPatient = async (req, res) => {
    ...
    db.serialize(function () {
        ...
        db.run("INSERT into Patient(patientTitleId,firstName,middleName,lastName," +
            "gender,dateOfBirth,nationality,contactId,addressId,emergencyInfoId,age,active) " +
            "VALUES (?,?,?,?,?,?,?,?,?,?,?,?)",
            [patientData.patientTitleId, patientData.firstName, patientData.middleName,
                ...
                contactId, addressId, emergencyId, patientData.age, patientData.active], function (err) {
                if (err) {
                    console.log(err);
